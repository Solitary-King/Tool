...
def generate_stylish_text(text):
    ...
    fonts = {
        ...
        "gothic": "𝔄𝔅𝔭𝔇𝔈𝔉𝔤ℌℑ𝔍𝔎𝔏𝔐𝔑𝔒𝔓𝔔ℜ𝔖𝔗𝔘𝔙𝔑𝔛𝔜ℨ𝔞𝔟𝔠𝔡𝔢𝔣𝔤𝔥𝔦𝔨𝔩𝔪𝔫𝔬𝔭𝔮𝔯𝔰𝔱𝔲𝔳𝔴𝔵𝔶𝔷0123456789",
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # User Features
        ...
        text = format_card("MORSE CODE", "যেকোনো লেখা পাঠালে সেটা Morse Code-ه‌ রূপান্তর করে দেওয়া হবে।")
        await query.edit_message_text(text, parse_mode='HTML', reply_markup=get_back_keyboard())
